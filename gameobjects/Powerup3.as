...

 {
    ...
    public class Powerup3 extends FlxSprite
    {
    [Embed(source='../data/Images/ImgPowerup3.png')] private var ImgPowerup:Class;
	...
	[Embed(source='../data/Sound/SndPowerup1.mp3')] private var SndPowerup1:Class;
        ...
        public function Powerup3(X:Number,Y:Number):void
        {
    ...
    super(X, Y);
		...
		//	coins.add();
					...
					loadGraphic(ImgPowerup,true, true, 36, 65);
		//	coins.add();
