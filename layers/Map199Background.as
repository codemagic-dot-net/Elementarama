package  layers
{
	 ...
	 * @author Marcel Flaig
	 */
	public class Map199Background extends FlxObject	{
...
[Embed(source='../data/Images/ImgCloud2.png')] private var ImgFront301:Class;	
	public var tilesize:uint = 32;
		...
		public function Map199Background() 
		{
									
	FlxState.bgColor = 0x00000000;
	
	var decoration:FlxSprite = new FlxSprite(50*tilesize,200,ImgFront301);
	decoration.moves = true;
		...
		FlxG.state.add(decoration);
		 ...
		 decoration = new FlxSprite(65*tilesize,200,ImgFront301);
	decoration.moves = true;
		decoration.solid = false;
		decoration.scale.x = 1;
		decoration.scale.y = 1;
		...
		FlxG.state.add(decoration);
		 ...
		 decoration = new FlxSprite(10*tilesize,200,ImgFront301);
	decoration.moves = true;
		decoration.solid = false;
		decoration.scale.x = -1;
		decoration.scale.y = 1;
		...
		FlxG.state.add(decoration);
					 ...
					 decoration = new FlxSprite(40 * tilesize, 200, ImgFront301);
