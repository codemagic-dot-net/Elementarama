...
import flash.events.TimerEvent;
    ...
    public class 	ContinuesState extends FlxState
    {
		 ...
		 
{
	...
	// Actors ;)	
				...
				_player2 = new FlxSprite(100, 800);
				...
				add(_player2);
			TweenMax.to(_player2, 3, { x:20, y:20, alpha:1.7, delay:0, repeat:-1, yoyo:true } );

				if (FlxG.lives >= 2)
				{ 
				_player2 = new FlxSprite(320, 680);
				_player2.loadGraphic(ImgPlayer,true,true,140/2,175);
				_player2.addAnimation("realidle", [14,15,16,17], 6, true);
				_player2.addAnimation("jump", [19, 20, 21,22,23], 3, false);
				add(_player2);
			...
			if (FlxG.lives == 3)
				{ 
				_player2 = new FlxSprite(200, 1800);
				_player2.loadGraphic(ImgPlayer,true,true,140/2,175);
				_player2.addAnimation("realidle", [14,15,16,17], 6, true);
				_player2.addAnimation("jump", [19, 20, 21,22,23], 3, false);
				add(_player2);
		...
		if (FlxG.lives < 1) { FlxG.state = new GameoverState; return; }
